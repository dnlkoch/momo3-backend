...
public class ProjectUserGroupPermissionEvaluatorTest {

	private ProjectUserGroupPermissionEvaluator<ProjectUserGroup> projectUserGroupPermissionEvaluator;
	 ...
	 *
	 */
	private ProjectUser testUser2;

	private ProjectUserGroup userGroupToTest;

	@Before
	public void set_up() throws NoSuchFieldException, IllegalAccessException {

		projectUserGroupPermissionEvaluator = new ProjectUserGroupPermissionEvaluator<ProjectUserGroup>();
	...
	public void hasPermission_shouldAllowCreateForUserWithRoleSuperAdmin() {
		...
		boolean permissionResult = projectUserGroupPermissionEvaluator.hasPermission(accessUser, userGroupToTest,
				createPermission);
