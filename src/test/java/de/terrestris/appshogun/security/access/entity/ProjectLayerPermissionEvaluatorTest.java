...
public class ProjectLayerPermissionEvaluatorTest {

	@InjectMocks
	private ProjectLayerPermissionEvaluator<ProjectLayer> projectLayerPermissionEvaluator;
	...
	private ProjectLayer testLayer;
	...
	public void set_up() throws NoSuchFieldException, IllegalAccessException {
		...
		projectLayerPermissionEvaluator = new ProjectLayerPermissionEvaluator<ProjectLayer>();
	...
	public void hasPermission_shouldDenyWithoutUserNorGroupPermissions() throws NoSuchFieldException, IllegalAccessException {
		...
		ProjectApplicationService<ProjectApplication, ProjectApplicationDao<ProjectApplication>> projectApplicationServiceMock =
				Mockito.mock(ProjectApplicationService.class);
		when(projectApplicationServiceMock.findAll()).thenReturn(new ArrayList<ProjectApplication>());
		projectLayerPermissionEvaluator.setProjectApplicationService(projectApplicationServiceMock);

		for (Permission permission : permissionsToCheck) {
			boolean permissionResult = projectLayerPermissionEvaluator.hasPermission(accessUser, testLayer, permission);
	...
	public void hasPermission_shouldAllowReadForUserGrantedFromUserPermissions() throws NoSuchFieldException, IllegalAccessException {
		...
		boolean permissionResult = projectLayerPermissionEvaluator.hasPermission(accessUser, testLayer, Permission.READ);
	...
	public void hasPermission_shouldAllowUpdateForUserGrantedFromUserPermissions() throws NoSuchFieldException, IllegalAccessException {
		...
		boolean permissionResult = projectLayerPermissionEvaluator.hasPermission(accessUser, testLayer, Permission.UPDATE);
		assertTrue(permissionResult);
	}
	...
	public void hasPermission_shouldAllowDeleteForUserGrantedFromUserPermissions() throws NoSuchFieldException, IllegalAccessException {
		...
		boolean permissionResult = projectLayerPermissionEvaluator.hasPermission(accessUser, testLayer, Permission.DELETE);
		assertTrue(permissionResult);
	}
	...
	public void hasPermission_shouldAllowDeleteForUserGrantedFromGroupPermissions() throws NoSuchFieldException, IllegalAccessException {
		...
		projectLayerPermissionEvaluator.setUserGroupRoleService(userGroupRoleService);
	...
	public void hasPermission_shouldDenyCreateForDefaultUser() throws NoSuchFieldException, IllegalAccessException {
		...
		boolean permissionResult = projectLayerPermissionEvaluator.hasPermission(accessUser, null, Permission.CREATE);
		assertFalse(permissionResult);
	}
