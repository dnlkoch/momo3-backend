 ...
 * @param <D>
 */
@Service("projectLayerService")
public class ProjectLayerService<E extends ProjectLayer, D extends ProjectLayerDao<E>>
	...
	public String getLayerExtent(Integer layerId) throws Exception {
		ProjectLayer layer = this.findById(layerId);
...
//							}
	...
	public void deleteProjectLayer(ProjectLayer layer) throws Exception {
