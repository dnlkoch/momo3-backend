 ...
 *
 */
@Service("projectPasswordResetTokenService")
public class ProjectPasswordResetTokenService<E extends PasswordResetToken, D extends PasswordResetTokenDao<E>>
	...
	public ProjectPasswordResetTokenService() {
	 ...
	 */
	protected ProjectPasswordResetTokenService(Class<E> entityClass) {
		super(entityClass);
	}
