...
@Service("projectInterceptorRuleService")
public class ProjectInterceptorRuleService extends InterceptorRuleService<InterceptorRule,
		InterceptorRuleDao<InterceptorRule>> {

	/**
	 * The Logger
	 */
	private static final Logger LOG = Logger.getLogger(ProjectInterceptorRuleService.class);
