...
*
*/
@Service("projectImageFileService")
public class ProjectImageFileService <E extends ImageFile, D extends ImageFileDao<E>>
	...
	public ProjectImageFileService() {
	 ...
	 */
	protected ProjectImageFileService(Class<E> entityClass) {
		super(entityClass);
	}
