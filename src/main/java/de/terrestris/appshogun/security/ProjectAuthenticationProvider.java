package de.terrestris.appshogun.security;
 ...
 *
 */
public class ProjectAuthenticationProvider extends Shogun2AuthenticationProvider {

	/**
	 * The Logger
	 */
	private static final Logger LOG = Logger
			.getLogger(ProjectAuthenticationProvider.class);
	...
	private ProjectUserDao<ProjectUser> projectUserDao;
	...
	public Authentication authenticate(Authentication authentication)
		...
		ProjectUser user = (ProjectUser) projectUserDao.findByAccountName(accountName);
