...
import de.terrestris.appshogun.service.ProjectPasswordResetTokenService;
...
public class ProjectUserController<E extends ProjectUser, D extends ProjectUserDao<E>, S extends ProjectUserService<E, D>>
	 ...
	 */
	protected ProjectUserController(Class<E> entityClass) {
		super(entityClass);
	}
	...
	@Autowired
	@Qualifier("projectPasswordResetTokenService")
	private ProjectPasswordResetTokenService<PasswordResetToken, PasswordResetTokenDao<PasswordResetToken>> projectPasswordResetTokenService;
	...
	public void activateProjectUser(
	...
	public @ResponseBody Map<String, Object> resetPassword(HttpServletRequest request,
		...
		try {
			projectPasswordResetTokenService.sendResetPasswordMail(request, email);
