...
import de.terrestris.appshogun.service.ProjectImageFileService;
 ...
 */
@Controller
@RequestMapping("/projectimage")
public class ProjectImageFileController<E extends ImageFile, D extends ImageFileDao<E>, S extends ProjectImageFileService<E, D>>
	...
	@Override
	@Autowired
	@Qualifier("projectImageFileService")
	...
	public ProjectImageFileController() {
	 ...
	 */
	protected ProjectImageFileController(Class<E> type) {
		super(type);
	}
