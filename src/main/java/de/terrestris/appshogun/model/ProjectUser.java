...
import de.terrestris.appshogun.util.serializer.ProjectUserSerializer;
 ...
 */
@Entity
@JsonSerialize(using = ProjectUserSerializer.class)
public class ProjectUser extends User {

	/**
	 * The Logger
	 */
	private static final Logger LOG = Logger.getLogger(ProjectUser.class);
