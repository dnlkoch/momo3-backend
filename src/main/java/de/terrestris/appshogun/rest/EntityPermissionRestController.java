...
import de.terrestris.appshogun.service.EntityPermissionService;
...
public class EntityPermissionRestController<E extends PersistentObject> {
	...
	/**
	 * e.g.
	 * http://localhost:8080/shogun2-webapp/rest/entitypermission/ProjectLayer/42/ProjectUser
	 *
	 * @param entityType
	 * @param entityId
	 * @param targetEntity
	...
	private @ResponseBody Map<String, Object> getApplicationEntityPermissions(
		...
		try {
			Class<?> clazz = Class.forName("de.terrestris.appshogun.model." + entityType);
